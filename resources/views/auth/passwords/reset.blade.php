    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="w3-card w3-animate-opacity">
                <div class="card-header w3-dark-grey">Zresetuj hasło</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="w3-input  @error('email') w3-border-bottom w3-border-red w3-pale-red @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
