...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row {{--align-items-center align-content-center align-self-center--}} {{--justify-content-center--}}">
            ...
            @forelse($cars as $car)
                <div class="w3-card card {{--col-3 --}}m-1 @if(1 % 5 == 0){{-- bg-danger text-white--}} w3-orange @endif"
                     style="width:32%">
                    <img class="w3-border-bottom w3-border-dark card-img-top"
                         ...
                         src="{{asset($car->photo)}}" alt="Car photo" style="width:100%">
                    <div class="card-body">
            ...
            @empty
                <div class="alert alert-info col-12">Wygląda na to że nie dodałeś/dodałaś jeszcze żadnego samochodu.</div>
            @endforelse
