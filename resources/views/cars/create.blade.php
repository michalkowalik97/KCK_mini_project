                ...
                <form action="/cars" method="POST" enctype="multipart/form-data" >
                 {{--   name	photo	mileage	user_id	reminder_id	created_at	updated_at	 --}}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="w3-input @error('name') w3-border-bottom w3-border-red w3-pale-red @enderror " value="{{ old('name') }}" required>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="przebieg" class="w3-input @error('przebieg') w3-border-bottom w3-border-red w3-pale-red @enderror" value="{{ old('przebieg') }}">
                        @error('przebieg')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
